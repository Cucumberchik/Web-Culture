...
function _bridgeSend(e, t) {
  androidBridge && androidBridge[e]
    ? androidBridge[e](JSON.stringify(t))
    : iosBridge &&
      iosBridge[e] &&
      "function" == typeof iosBridge[e].postMessage &&
      iosBridge[e].postMessage(t);
}
function _bridgeSupports(e) {
  return IS_ANDROID_WEBVIEW
    ? androidBridge && "function" == typeof androidBridge[e]
    : !!IS_IOS_WEBVIEW &&
        iosBridge &&
        iosBridge[e] &&
        "function" == typeof iosBridge[e].postMessage;
...
if (
  ((function (e) {
      ...
      (e.fastXDM = {
        ...
        Server: function (o, i, n) {
          (this.methods = o || {}),
            ...
            (this.server = !0),
            (this.methods["%init%"] = this.methods.__fxdm_i =
              function () {
                d(function (t) {
                  for (var o in this.methods)
                    if (this.methods[o] instanceof e.fastXDM.Server) {
                      ...
                      "p" === t.protocol &&
                        t.send(this, t.json.stringify(["%proxy%", [o, i.key]])),
                        (this.methods[o] = function () {
        ...
        Client: function (i, n) {
          ...
          (this.key = window.name.substring(3, 8)),
            ...
            o[this.key] || (o[this.key] = {}),
            (this.methods["%proxy%"] = function (e, t) {
              e &&
                t &&
                this.caller.frames["fXD" + t] &&
                (o[this.key][e] = {
                  key: t,
                  frame: { contentWindow: this.caller.frames["fXD" + t] },
                });
            }.bind(this)),
            (t[this.key] = [p, this]),
            e.fastXDM.on(
        ...
        onMessage: function (e) {
          ...
          if (t[i]) {
            var n = t[i][1];
            !n ||
              (n.filter && !n.filter(e.origin)) ||
              t[i][0](o.substr(6), n, e.origin);
          }
        },
        setJSON: function (e) {
          n.json = e;
        ...
        on: function (e, t, o) {
          this._q[e] || (this._q[e] = []),
            -1 == this._q[e] ? t.apply(o) : this._q[e].push([t, o]);
        },
        run: function (e) {
          for (var t = (this._q[e] || []).length, o = 0; o < t; o++)
            this._q[e][o][0].apply(this._q[e][o][1]);
          this._q[e] = -1;
        },
        waitFor: r,
      }),
        ...
        (e.fastXDM.Server.prototype.append = function (e, t, o) {
          ...
          i.innerHTML =
            '<iframe name="' + this.frameName + '" ' + (o || "") + "></iframe>";
          var n = i.firstChild,
            r = this;
          return (
            setTimeout(function () {
        ...
        (e.fastXDM.Client.prototype.callMethod =
          e.fastXDM.Server.prototype.callMethod =
            function () {
              for (
        ...
        (e.fastXDM.Client.prototype.isUnsafeMethod =
          e.fastXDM.Server.prototype.isUnsafeMethod =
            function (e) {
              return (
                ~["%proxy%", "%init%"].indexOf(e) ||
                (this.options.unsafeMethods &&
                  ~this.options.unsafeMethods.indexOf(e))
              );
            }),
        e.JSON &&
        "object" == typeof e.JSON &&
        e.JSON.parse &&
        e.JSON.stringify &&
        '{"a":[1,2,3]}' === e.JSON.stringify({ a: [1, 2, 3] }).replace(/ /g, "")
          ? (n.json = { parse: e.JSON.parse, stringify: e.JSON.stringify })
        ...
        e.postMessage
          ? ((n.protocol = "p"),
            ...
            e.addEventListener
              ? e.addEventListener("message", e.fastXDM.onMessage, !1)
              : e.attachEvent("onmessage", e.fastXDM.onMessage),
            e.fastXDM._needJSON ? ((e.fastXDM._onlyJSON = !0), s()) : l())
          : s();
    }
      ...
      switch (typeof e) {
        ...
        case "object":
          if ("[object Array]" === Object.prototype.toString.apply(e)) {
            ...
            for (var r in ((o = {}), e))
              Object.hasOwnProperty.call(e, r) && (o[r] = a(e[r], t));
          break;
        default:
          o = e;
      }
    ...
    function p(t, o, i) {
      d(function (n) {
        ...
        if (s) {
          ...
          setTimeout(function () {
            if (!o.methods[s])
              throw Error("fastXDM: Method " + s + " is undefined");
    ...
    function u(e, t) {
      for (var o in t)
        e[o] && "object" == typeof e[o] ? u(e[o], t[o]) : (e[o] = t[o]);
    }
  })(window),
  window.VK || (window.VK = {}),
  VK.MD5 ||
    (VK.MD5 = function (e) {
      ...
      return (function (e) {
        for (
          var t, o = "0123456789abcdef", i = "", n = 0, r = e.length;
          n < r;
          n++
        )
          (t = e.charCodeAt(n)),
        ...
        (function (e) {
          for (var t = "", o = 0, i = 32 * e.length; o < i; o += 8)
          ...
          (function (e, t) {
            ...
            for (var g = 0, m = e.length; g < m; g += 16)
              (i = u),
                (d = c),
                (l = h),
                (p = f),
                (u = n(u, c, h, f, e[g + 0], 7, -680876936)),
                (f = n(f, u, c, h, e[g + 1], 12, -389564586)),
                (h = n(h, f, u, c, e[g + 2], 17, 606105819)),
                (c = n(c, h, f, u, e[g + 3], 22, -1044525330)),
                (u = n(u, c, h, f, e[g + 4], 7, -176418897)),
                (f = n(f, u, c, h, e[g + 5], 12, 1200080426)),
                (h = n(h, f, u, c, e[g + 6], 17, -1473231341)),
                (c = n(c, h, f, u, e[g + 7], 22, -45705983)),
                (u = n(u, c, h, f, e[g + 8], 7, 1770035416)),
                (f = n(f, u, c, h, e[g + 9], 12, -1958414417)),
                (h = n(h, f, u, c, e[g + 10], 17, -42063)),
                (c = n(c, h, f, u, e[g + 11], 22, -1990404162)),
                (u = n(u, c, h, f, e[g + 12], 7, 1804603682)),
                (f = n(f, u, c, h, e[g + 13], 12, -40341101)),
                (h = n(h, f, u, c, e[g + 14], 17, -1502002290)),
                (c = n(c, h, f, u, e[g + 15], 22, 1236535329)),
                (u = r(u, c, h, f, e[g + 1], 5, -165796510)),
                (f = r(f, u, c, h, e[g + 6], 9, -1069501632)),
                (h = r(h, f, u, c, e[g + 11], 14, 643717713)),
                (c = r(c, h, f, u, e[g + 0], 20, -373897302)),
                (u = r(u, c, h, f, e[g + 5], 5, -701558691)),
                (f = r(f, u, c, h, e[g + 10], 9, 38016083)),
                (h = r(h, f, u, c, e[g + 15], 14, -660478335)),
                (c = r(c, h, f, u, e[g + 4], 20, -405537848)),
                (u = r(u, c, h, f, e[g + 9], 5, 568446438)),
                (f = r(f, u, c, h, e[g + 14], 9, -1019803690)),
                (h = r(h, f, u, c, e[g + 3], 14, -187363961)),
                (c = r(c, h, f, u, e[g + 8], 20, 1163531501)),
                (u = r(u, c, h, f, e[g + 13], 5, -1444681467)),
                (f = r(f, u, c, h, e[g + 2], 9, -51403784)),
                (h = r(h, f, u, c, e[g + 7], 14, 1735328473)),
                (c = r(c, h, f, u, e[g + 12], 20, -1926607734)),
                (u = s(u, c, h, f, e[g + 5], 4, -378558)),
                (f = s(f, u, c, h, e[g + 8], 11, -2022574463)),
                (h = s(h, f, u, c, e[g + 11], 16, 1839030562)),
                (c = s(c, h, f, u, e[g + 14], 23, -35309556)),
                (u = s(u, c, h, f, e[g + 1], 4, -1530992060)),
                (f = s(f, u, c, h, e[g + 4], 11, 1272893353)),
                (h = s(h, f, u, c, e[g + 7], 16, -155497632)),
                (c = s(c, h, f, u, e[g + 10], 23, -1094730640)),
                (u = s(u, c, h, f, e[g + 13], 4, 681279174)),
                (f = s(f, u, c, h, e[g + 0], 11, -358537222)),
                (h = s(h, f, u, c, e[g + 3], 16, -722521979)),
                (c = s(c, h, f, u, e[g + 6], 23, 76029189)),
                (u = s(u, c, h, f, e[g + 9], 4, -640364487)),
                (f = s(f, u, c, h, e[g + 12], 11, -421815835)),
                (h = s(h, f, u, c, e[g + 15], 16, 530742520)),
                (c = s(c, h, f, u, e[g + 2], 23, -995338651)),
                (u = a(u, c, h, f, e[g + 0], 6, -198630844)),
                (f = a(f, u, c, h, e[g + 7], 10, 1126891415)),
                (h = a(h, f, u, c, e[g + 14], 15, -1416354905)),
                (c = a(c, h, f, u, e[g + 5], 21, -57434055)),
                (u = a(u, c, h, f, e[g + 12], 6, 1700485571)),
                (f = a(f, u, c, h, e[g + 3], 10, -1894986606)),
                (h = a(h, f, u, c, e[g + 10], 15, -1051523)),
                (c = a(c, h, f, u, e[g + 1], 21, -2054922799)),
                (u = a(u, c, h, f, e[g + 8], 6, 1873313359)),
                (f = a(f, u, c, h, e[g + 15], 10, -30611744)),
                (h = a(h, f, u, c, e[g + 6], 15, -1560198380)),
                (c = a(c, h, f, u, e[g + 13], 21, 1309151649)),
                (u = a(u, c, h, f, e[g + 4], 6, -145523070)),
                (f = a(f, u, c, h, e[g + 11], 10, -1120210379)),
                (h = a(h, f, u, c, e[g + 2], 15, 718787259)),
                (c = a(c, h, f, u, e[g + 9], 21, -343485551)),
                (u = o(u, i)),
                (c = o(c, d)),
                (h = o(h, l)),
                (f = o(f, p));
            ...
            (function (e) {
              ...
              for (t = 0, o = 8 * e.length; t < o; t += 8)
                i[t >> 5] |= (255 & e.charCodeAt(t / 8)) << t % 32;
              return i;
            })(
              (t = (function (e) {
                for (var t, o, i = "", n = -1, r = e.length; ++n < r; )
                  (t = e.charCodeAt(n)),
                    (o = n + 1 < r ? e.charCodeAt(n + 1) : 0),
                    55296 <= t &&
                      t <= 56319 &&
                      56320 <= o &&
                      o <= 57343 &&
                      ((t = 65536 + ((1023 & t) << 10) + (1023 & o)), n++),
                    t <= 127
      ...
      e.hasOwnProperty(o) &&
        t.push(
          encodeURIComponent(o) +
            "=" +
            encodeURIComponent(e[o].toString() || "")
        );
  ...
  VK.extend(VK, {
    ...
    (VK.init = function (e) {
      var t, o;
      if (((VK._apiId = null), !e.apiId))
        throw Error("VK.init() called without an apiId");
      if (((VK._apiId = e.apiId), e.onlyWidgets)) return !0;
      e.nameTransportPath &&
        "" !== e.nameTransportPath &&
        (VK._nameTransportPath = e.nameTransportPath),
        (o = document.getElementById(VK._rootId)) ||
          (((o = document.createElement("div")).id = VK._rootId),
          (t = document.body).insertBefore(o, t.childNodes[0])),
    ...
    VK.Cookie ||
      (VK.Cookie = {
        ...
        load: function () {
          var e,
            t = document.cookie.match("\\bvk_app_" + VK._apiId + "=([^;]*)\\b");
          if (t) {
        ...
        setRaw: function (e, t, o, i) {
          ...
          (n += e && 0 === t ? "" : "; expires=" + new Date(r).toGMTString()),
            (n += "; path=/"),
            (n += o ? "; domain=." + o : ""),
            (document.cookie = n),
            (this._domain = o);
      ...
      ((VK.Api = {
        ...
        createRequest: function (e, t) {
          ...
          return (
            "withCredentials" in o
              ? (o.open(e, t, !0), (o.withCredentials = !0))
              : "undefined" != typeof XDomainRequest
        ...
        checkMethod: function (e, t, o, i) {
          ...
          if ("wall.post" === n) {
            ...
            t.v || (t.v = "5.95"),
              ...
              "string" == typeof t.attachments &&
                (t.attachments = t.attachments.split(","));
            for (var u = 0; u < t.attachments.length; u++) {
              var c = t.attachments[u].trim();
              l.test(c) && p.push(c);
            }
            return (
              (t.attachments = p.length ? p : ""),
              (r = "_" + Math.random().toString(16).substr(2)),
              (s = {
                act: "wall_post_box",
                method: n,
                widget: 4,
              ...
              ((s = VK.extend(s, t)).owner_id = parseInt(t.owner_id || 0, 10)),
              (s.publish_date = t.publish_date || ""),
              (a = VK._domain.base + "/al_apps.php"),
              (a += obj2qs(s)),
              VK.UI.popup({ url: a, width: 560, height: 304 }),
        ...
        call: function (e, t, o, i) {
          ...
          if (
            t.method_access ||
            t.method_force ||
            VK.Api.checkMethod(e, t, o, i)
          ) {
            if ((i || (i = 0), "loaded" != VK.Auth._loadState)) {
              var a = function (i) {
                i &&
                  i.session &&
                  (VK.Observer.unsubscribe("auth.loginStatus", a),
                  VK.Api.call(e, t, o));
              };
              return (
                VK.Observer.subscribe("auth.loginStatus", a),
                void VK.Auth.getLoginStatus()
              );
            }
            if (VK.Api.queryLength(s) < 1500 && !VK.Api.ie6_7()) {
              for (
                var d = !1, l = parseInt(1e7 * Math.random(), 10);
                VK.Api._callbacks[l];
            ...
            VK._session &&
              VK._session.sid &&
              (s.access_token = VK._session.sid),
              (n = VK.Cookie.encode(s)),
              (r = function (n) {
                if (
                  !n.error ||
                  (3 != n.error.error_code &&
                    4 != n.error.error_code &&
                    5 != n.error.error_code)
                )
                  o(n);
                else {
                  if (i > 3) return !1;
                  var r = function (n) {
                    VK.Observer.unsubscribe("auth.sessionChange", r),
                      ...
                      n.session && VK.Api.call(e, t, o, i + 1);
                  };
                  VK.Observer.subscribe("auth.sessionChange", r),
              ...
              d
                ? VK.xdReady
                  ...
                  : (VK.Observer.subscribe("xdm.init", function () {
                    ...
                    VK.XDM.init())
                : ((VK.Api._callbacks[l] = r),
                  VK.Api.attachScript(
                    VK._domain.api + "/method/" + e + "?" + n
                  ));
          }
        },
      ...
      (VK.Auth = {
        ...
        setSession: function (e, t, o, i) {
          var n = !VK._session && e,
            ...
            d = t != VK._userStatus,
            l = { session: e, status: t, settings: o };
          return (
            (VK._session = e),
            (VK._userStatus = t),
            VK.Cookie.set(e, i),
            (a || d || s) &&
              setTimeout(function () {
                d && VK.Observer.publish("auth.statusChange", l),
                  (r || s) && VK.Observer.publish("auth.logout", l),
                  (n || s) && VK.Observer.publish("auth.login", l),
                  a && VK.Observer.publish("auth.sessionChange", l);
              }, 0),
            l
          );
        },
        login: function (e, t) {
          ...
          t && parseInt(t, 10) > 0 && (o += "&scope=" + t),
            VK.Observer.unsubscribe("auth.onLogin"),
            VK.Observer.subscribe("auth.onLogin", e),
            VK.UI.popup({ width: 665, height: 370, url: o });
          var i = function () {
          ...
          if (VK._apiId) {
            ...
            if (force || "loading" != VK.Auth._loadState) {
              ...
              if (VK.Api.supportCORS()) {
                ...
                for (
                  var rnd = parseInt(1e7 * Math.random(), 10);
                  VK.Auth.lsCb[rnd];
    ...
    VK.App ||
      (VK.App = {
        ...
        _openApp: function (e, t) {
          ...
          if (((t = t || {}), e && VK._apiId && !VK.App._appOpened)) {
            ...
            t)) {
              var s = "";
              t.hasOwnProperty(r) &&
                (void 0 !== t[r] && (s = encodeURIComponent(t[r])),
                n.push(encodeURIComponent(r) + "=" + s));
            }
            (o += "&url=" + e),
              (o += "&q=" + encodeURIComponent(n.join("&"))),
              (i = VK.Util.Box(
                o,
                {},
                {
                  ...
                  externalAppDone: function (e, t) {
                    t
                      ? (VK.App._result = e)
                      : (VK.Observer.publish("app.done", e),
                        i.hide(),
                        (VK.App._appOpened = !1),
                        (VK.App._result = null));
                  },
        ...
        addToGroup: function (e) {
          (this._addToGroupPopup && !this._addToGroupPopup.closed) ||
            (this._onAddToGroupDone &&
              VK.Util.removeEvent("message", this._onAddToGroupDone, window),
            (this._onAddToGroupDone = function (e) {
              e.origin === VK._domain.base &&
                "app.addToGroup" === e.data.method &&
    ...
    popup: function (e) {
      ...
      return (
        (t =
          ...
          ",left=" +
          (d =
            window.screen && window.screenX && screen.left && screen.left > 1e3
              ? 0
              : d) +
          ",top=" +
          l),
    ...
    button: function (e, t) {
      ...
      "string" == typeof e && (e = document.getElementById(e)),
        ...
        (o =
          ...
          index +
          ');" style="cursor: pointer; border: 0px; font-family: tahoma, arial, verdana, sans-serif, Lucida Sans; font-size: 10px;"><tr style="vertical-align: middle"><td><div style="border: 1px solid #3b6798;border-radius: 2px 0px 0px 2px;-moz-border-radius: 2px 0px 0px 2px;-webkit-border-radius: 2px 0px 0px 2px;"><div style="border: 1px solid #5c82ab; border-top-color: #7e9cbc; background-color: #6D8DB1; color: #fff; text-shadow: 0px 1px #45688E; height: 15px; padding: 2px 4px 0px 6px;line-height: 13px;">&#1042;&#1086;&#1081;&#1090;&#1080;</div></div></td><td><div style="background: url(' +
          VK._domain.base +
          '/images/btns.png) 0px -42px no-repeat; width: 21px; height: 21px"></div></td><td><div style="border: 1px solid #3b6798;border-radius: 0px 2px 2px 0px;-moz-border-radius: 0px 2px 2px 0px;-webkit-border-radius: 0px 2px 2px 0px;"><div style="border: 1px solid #5c82ab; border-top-color: #7e9cbc; background-color: #6D8DB1; color: #fff; text-shadow: 0px 1px #45688E; height: 15px; padding: 2px 6px 0px 4px;line-height: 13px;">&#1050;&#1086;&#1085;&#1090;&#1072;&#1082;&#1090;&#1077;</div></div></td></tr></table>'),
        (e.innerHTML = o),
        (e.style.width = e.childNodes[0].offsetWidth + "px");
    },
    _change: function (e, t) {
      for (
        var o = document.getElementById("openapi_UI_" + t).rows[0],
          i = [
            o.cells[0].firstChild.firstChild,
            o.cells[2].firstChild.firstChild,
          ],
          n = 0;
        n < 2;
        ++n
        ...
        var r = i[n];
        0 === e
          ? ((r.style.backgroundColor = "#6D8DB1"),
            (r.style.borderTopColor = "#7E9CBC"),
            (r.style.borderLeftColor =
              r.style.borderRightColor =
              r.style.borderBottomColor =
                "#5C82AB"))
          : 1 == e
            ? ((r.style.backgroundColor = "#7693B6"),
              (r.style.borderTopColor = "#88A4C4"),
              (r.style.borderLeftColor =
                r.style.borderRightColor =
                r.style.borderBottomColor =
                  "#6088B4"))
            : 2 == e &&
              ((r.style.backgroundColor = "#6688AD"),
              (r.style.borderBottomColor = "#7495B8"),
              (r.style.borderLeftColor =
                r.style.borderRightColor =
      ...
      0 === e || 2 == e
        ? (o.cells[2].firstChild.style.backgroundPosition = "0px -42px")
        : 1 == e &&
          (o.cells[2].firstChild.style.backgroundPosition = "0px -63px");
    },
  }),
  VK.XDM ||
    (VK.XDM = {
  ...
  VK.Widgets ||
    ...
    (VK.Widgets.Comments = function (e, t, o) {
      ...
      var n,
        ...
        a = function (e) {
          n.callMethod("mouseMove", { screenY: e.screenY });
        };
      if (t.browse) (r.browse = 1), (r.replies = t.replies || 0);
      else {
        var d = t.pageUrl || i.url;
        "/" == d.substr(0, 1) &&
          (d = location.protocol + "//" + location.host + d),
          VK.extend(r, {
            page: o || 0,
        ...
        VK.Widgets._constructor(
          ...
          r,
          {
            showBox: function (e, t) {
              VK.Util.Box(VK.Util.getAbsUrl(e), [], { proxy: n }).show();
            },
            startDrag: function () {
              (cursorBack = window.document.body.style.cursor),
                (window.document.body.style.cursor = "pointer"),
                VK.Util.addEvent("mousemove", a),
                VK.Util.addEvent("mouseup", s);
            },
            stopDrag: function () {
              (window.document.body.style.cursor = cursorBack),
                VK.Util.removeEvent("mousemove", a),
                VK.Util.removeEvent("mouseup", s);
            },
          },
          { startHeight: 133, minWidth: 300 },
          function (e, t, o) {
            t, (n = o);
          }
        )
    ...
    (VK.Widgets.CommentsBrowse = function (e, t) {
      return (
        ((t = VK.Util.parseOptions(t)).browse = 1), VK.Widgets.Comments(e, t)
      );
    }),
    (VK.Widgets.Recommended = function (e, t) {
      ...
      return VK.Widgets._constructor(
        ...
        o,
        {},
        { startHeight: 116 + 47 * o.limit - 15, minWidth: 150 }
      );
    }),
    (VK.Widgets.Post = function (e, t, o, i, n) {
      ...
      return VK.Widgets._constructor(
        ...
        {
          showBox: function (e, t) {
            VK.Util.Box(VK.Util.getAbsUrl(e), [], { proxy: r }).show();
          },
          startDrag: function () {
    ...
    (VK.Widgets.TextLive = function (e, t, o, i, n) {
      return (
        ...
        VK.Widgets._constructor(
          ...
          e,
          n,
          { textlive_id: t, textpost_id: o, hash: i || "" },
          null,
          { startHeight: o ? 176 : 167, minWidth: 320 }
        )
      );
    }),
      ...
      return (
        (e = function (e, o, i) {
          ...
          var r,
            ...
            l,
            p,
            u = { 18: 43, 20: 47, 22: 51, 24: 55, 30: 67 },
            c =
              "full" ==
                (o = VK.extend(VK.Util.parseOptions(o), {
                  allowTransparency: !0,
                })).type ||
              "button" == o.type ||
              "vertical" == o.type ||
          ...
          function V(e) {
            if (
              ...
              d &&
              l &&
              ("none" == d.style.display || "yes" == d.getAttribute("vkhidden"))
            ) {
              ...
              var t = o.getScrollTop
                ...
                n = v ? 0 : i[1];
              (t > i[1] - 120 && "top" != o.tooltipPos) ||
              "vertical" == c ||
              "bottom" == o.tooltipPos
                ? ((d.style.top = n + _ + 2 + "px"),
                  l.callMethod("show", !1, c + "_" + g))
                : ((d.style.top = n - 128 + "px"),
                  l.callMethod("show", !0, c + "_" + g)),
                VK.Util.ss(d, {
                  left:
                    (v ? 0 : i[0]) -
                    ("full" == c || "button" == c ? 32 : 2) +
                    "px",
                  display: "block",
                  opacity: 1,
                  filter: "none",
          ...
          ("vertical" != c && "button" != c && "mini" != c) || delete o.width,
            h && (y.auto_width = 1);
          var x = VK.Widgets._constructor(
            "widget_like.php",
            e,
            o,
            y,
            {
              ...
              showBox: function (e, t) {
                VK.Util.Box(VK.Util.getAbsUrl(e), [], { proxy: a }).show();
              },
              proxy: function () {
                l && l.callMethod.apply(l, arguments);
              },
            },
            { startHeight: _, minWidth: m },
            function (e, t, o) {
              (a = o),
                VK.Util.ss((r = e), {
                  height: _ + "px",
    ...
    (VK.Widgets.Poll = function (e, t, o) {
      var i = VK.Util.getPageData();
      ...
      return (
        t.preview && ((r.is_preview = 1), delete t.preview),
        void 0 !== t.share && (r.share = t.share ? 1 : 0),
        VK.Widgets._constructor(
          "al_widget_poll.php",
          e,
          t,
    ...
    (VK.Widgets.App = function (e, t, o) {
      ...
      var i,
        n = void 0,
        r = void 0,
        s = { aid: t, mode: parseInt(o.mode, 10) || 1 };
      switch (s.mode) {
        case 1:
          (o.width = 144), (n = 251);
          break;
        case 2:
          (o.width = o.width
            ? Math.max(200, Math.min(1e4, parseInt(o.width, 10)))
            : 200),
            (r = n = 193);
          break;
        case 3:
          (o.width = o.width
            ? Math.max(50, Math.min(1e4, parseInt(o.width, 10)))
            : void 0),
            (r =
              n =
              o.height =
      ...
      return (
        ...
        VK.Widgets._constructor(
          ...
          s,
          {},
          { startHeight: n, height: r, minWidth: i }
        )
      );
    }),
    (VK.Widgets.Community = VK.Widgets.Group =
      function (e, t, o) {
        if (((t = VK.Util.parseOptions(t)), !(o = parseInt(o, 10))))
          throw Error("No group_id passed");
        t.mode = parseInt(t.mode, 10).toString();
        var i,
          n,
          r = { gid: o, mode: t.mode ? t.mode : "0" },
          s = 3 == t.mode ? 185 : 1 == t.mode ? 141 : 0 | t.height || 290;
        function a() {
          return i.callMethod("mouseUp"), !1;
        }
        function d(e) {
          return i.callMethod("mouseMove", { screenY: e.screenY }), !1;
        }
        return (
          t.wall && (r.wall = t.wall),
          (r.color1 = t.color1 || ""),
          (r.color2 = t.color2 || ""),
          (r.color3 = t.color3 || ""),
          (r.class_name = t.class_name || ""),
          t.no_head && (r.no_head = 1),
          t.no_cover && (r.no_cover = 1),
          t.wide &&
            ((r.wide = 1), (!t.width || t.width < 300) && (t.width = 300)),
          ...
          VK.Widgets._constructor(
            ...
            {
              showBox: function (e, t) {
                VK.Util.Box(VK.Util.getAbsUrl(e), [], { proxy: i }).show();
              },
              startDrag: function () {
                (n = window.document.body.style.cursor),
                  (window.document.body.style.cursor = "pointer"),
                  VK.Util.addEvent("mousemove", d),
                  VK.Util.addEvent("mouseup", a);
              },
              stopDrag: function () {
                (window.document.body.style.cursor = n),
                  VK.Util.removeEvent("mousemove", d),
                  VK.Util.removeEvent("mouseup", a);
              },
              auth: function () {
                VK.Auth.login(null, 1);
              },
            },
            { minWidth: 120, startHeight: s },
            function (e, t, o) {
              i = o;
            }
          )
    ...
    (VK.Widgets.Auth = function (e, t) {
      ...
      if (!VK._apiId) throw Error("VK not initialized. Please use VK.init");
      return (
        (t = VK.Util.parseOptions(t)).width || (t.width = 200),
        t.type ? (type = 1) : (type = 0),
        VK.Widgets._constructor(
          "widget_auth.php",
          e,
          t,
    ...
    (VK.Widgets.Subscribe = function (e, t, o) {
      ...
      var i,
        n = { oid: o };
      return (
        (t = VK.Util.parseOptions(t)).mode && (n.mode = t.mode),
        t.soft && (n.soft = t.soft),
        VK.Widgets._constructor(
    ...
    (VK.Widgets.ContactUs = function (e, t, o) {
      ...
      return VK.Widgets._constructor(
        ...
        i,
        {},
        { startHeight: i.height, height: i.height },
        function (e, t, o) {
          o;
        }
      );
    ...
    (VK.Widgets.Bookmarks = function (e, t) {
      ...
      return VK.Widgets._constructor(
        ...
        o,
        {},
        { startHeight: o.height, height: o.height },
        function (e, t, o) {
          o;
        }
      );
    ...
    (VK.Widgets.Playlist = function (e, t, o, i, n) {
      var r,
        s = { oid: parseInt(t, 10), pid: parseInt(o, 10), hash: i || "" };
    ...
    (VK.Widgets.Ads = function (e, t, o) {
      ...
      if (a && a.getBoundingClientRect) {
        ...
        (a.style.width = ""),
          (a.style.height = ""),
          (d.ads_ad_unit_width_auto = Math.floor(h.right - h.left)),
          (d.ads_ad_unit_height_auto = Math.floor(h.bottom - h.top));
      }
      return (
        (p.ads_ad_unit_width = 100),
        (p.ads_ad_unit_height = 100),
        (l.ads_ad_unit_width =
          parseInt(d.ads_ad_unit_width) ||
          ("auto" === d.ads_ad_unit_width && d.ads_ad_unit_width_auto) ||
          p.ads_ad_unit_width),
        (l.ads_ad_unit_height =
          parseInt(d.ads_ad_unit_height) ||
          ("auto" === d.ads_ad_unit_height && d.ads_ad_unit_height_auto) ||
          p.ads_ad_unit_height),
        d.ads_handler && (l.ads_handler = d.ads_handler),
        d.ads_handler_empty_html &&
          (l.ads_handler_empty_html = d.ads_handler_empty_html),
        delete d.ads_handler,
        delete d.ads_handler_empty_html,
        (n.act = "ads_web"),
        (n.url = location.href),
        VK.extend(n, d),
        (t.noDefaultParams = !0),
        ...
        (s.adsOnInit = function (e, o) {
          VK.Widgets.loading(a, !1),
            (function (e) {
              if (!e) return;
              for (var t in e) {
                var o = e[t];
                "ads_ad_unit_width" === t || "ads_ad_unit_height" === t
                  ? t in d ||
                    (l[t] =
                      parseInt(o) || ("auto" === o && d[t + "_auto"]) || p[t])
                  : t in l || (l[t] = o);
              }
            })(o),
            t.onAdsReady &&
          ...
          !(function (e) {
            ...
            if (e <= 0 && !0 !== t) {
              try {
                console.log(
                  "VK: ad_unit_id = " + d.ads_ad_unit_id,
                  ", errorCode = ",
                  e
                );
              } catch (e) {}
              !(function (e, t, o) {
                ...
                function s() {
                  if (!o)
                    try {
                      var e =
                          r.contentWindow.document.body.firstChild.getBoundingClientRect(),
                ...
                (r.onload = s),
                  (r.id =
                    (i ? i.id : "vkwidget-" + Math.round(1e6 * Math.random())) +
                    "_ads_html_handler"),
                  (r.src = "about:blank"),
                  (r.width = "100%"),
                  (r.height = "100%"),
                  ...
                  (a.style.height = o),
                  a.appendChild(r),
                  (r.contentWindow.vk_ads_html_handler = n),
                  (r.src = 'javascript:window["vk_ads_html_handler"]');
              })(
                l.ads_handler_empty_html,
                l.ads_ad_unit_width,
                l.ads_ad_unit_height
              );
            }
          ...
          !(function (e) {
            if ("vk__adsLight" in window)
              window.vk__adsLight &&
                ...
                vk__adsLight.userHandlers.onInit(!1);
            else {
    ...
    (VK.Widgets.AllowMessagesFromCommunity = function (e, t, o) {
      ...
      t = VK.Util.parseOptions(t);
      var i = {
        height: { 22: 22, 24: 24, 30: 30 }[parseInt(t.height, 10) || 24],
    ...
    (VK.Widgets.Podcast = function (e, t, o) {
      ...
      return (
        ...
        VK.Widgets._constructor(
          ...
          {
            showBox: function (e) {
              VK.Util.Box(VK.Util.getAbsUrl(e), [], { proxy: rpc }).show();
            },
          },
    ...
    (VK.Widgets.CommunityMessages = (function (e) {
      ...
      var t = {},
        ...
        i = {
          ...
          blue_circle: { width: 50, height: 50, margin: { bottom: 20 } },
        },
        n = { left: { bottom: 0, left: 20 }, right: { bottom: 0, right: 20 } };
      return (
        (e = function (r, s, a) {
          ((a = VK.Util.parseOptions(a)).width = 300),
            (a.height = 399),
            (a.expandTimeout = parseInt(a.expandTimeout) || 0);
          var d = { gid: s };
          (a.expanded = parseInt(a.expanded) || 0),
            ((!a.from_dev &&
              null !=
                (function (e) {
              ...
              (a.shown = 1),
            a.shown && (d.shown = 1),
            a.welcomeScreen || (d.disable_welcome_screen = 1),
            (d.ref_source_info = a.ref_source_info),
            (d.ref_source_link = location.href);
          var l = a.buttonType;
          -1 == Object.keys(i).indexOf(l) && (l = "blue_circle"),
            "no_button" == l && (a.disableButtonTooltip = 1),
            a.disableButtonTooltip && (d.disable_tooltip = 1),
            a.tooltipButtonText && (d.tooltip_text = a.tooltipButtonText),
            a.disableNewMessagesSound && (d.disable_new_messages_sound = 1),
            t[r] && e.destroy(r),
            (d.domain = document.domain),
            (a.no_loading = 1),
            (a.disableNewMessagesSound && a.disableExpandChatSound) ||
              (a.enable_autoplay = 1),
            a.disableExpandChatSound && (d.disable_expand_chat_sound = 1),
            a.expandTimeout && (d.expand_timeout = a.expandTimeout),
            a.__alpha_new_widget && (d.__alpha_new_widget = 1);
          var p,
            u,
            c,
            h = !1,
            ...
            g = [0, 0];
          V(a.widgetPosition),
            (d.button_position = a.widgetPosition),
              ...
              function (e) {
                ...
                if (e.data && "VKReforgedWidgetResize" === e.data.action) {
                  ...
                  (o.width = i),
                    ...
                    (t.style.width = i + "px"),
                    (t.style.height = n + "px"),
                    (t.style.margin = n > 50 ? "0" : "0 0 20px");
                }
                e.data &&
                  "VKReforgedWidgetLogout" === e.data.action &&
                  (o.parentNode.removeChild(o), (t.style = {}));
              },
              !1
            );
          var m = 0,
            _ = {};
          function y(e) {
            clearTimeout(o.titleTimer),
              (o.titleTimer = setTimeout(
                function () {
                  1 == o.changeTitleMode
                    ? (document.title = o.oldTitle || "")
                    : (document.title = o.title),
                    (o.changeTitleMode = 1 == o.changeTitleMode ? 0 : 1),
                    y();
                },
                e ? 0 : 1500
              ));
          ...
          function v() {
            a.disableTitleChange ||
              (clearTimeout(o.titleTimer),
              o.oldTitle
                ? (document.title = o.oldTitle)
                : null === o.oldTitle && (document.title = ""),
              (o.title = ""));
          }
          function b() {
          ...
          function w() {
            ...
            (e.style.margin =
              "0px " + (a.right || 0) + "px " + (a.bottom || 0) + "px 0px"),
              t &&
                ((t.style.boxShadow = "none"), (t.width = n), (t.height = s));
          }
          function V(e) {
            (p = e),
              -1 == Object.keys(n).indexOf(p) && (p = "right"),
              K(),
              x("changeButtonPosition", p);
          }
          function K() {
            var e = document.getElementById(r);
            if (e) {
          ...
          function I(e) {
            (e && "[object Object]" === Object.prototype.toString.call(e)) ||
              (e = {}),
              null == e.welcomeScreen && (e.welcomeScreen = a.welcomeScreen);
            var t = document
              .getElementById(r)
          ...
          function C(e) {
            x("setSourceData", VK.extend({ link: location.href }, e));
          }
          return (
            (t[r] = VK.Widgets._constructor(
              "reforged_widget.php",
              r,
              a,
              d,
              {
                ...
                onReady: function () {
                  (m = 1),
                    a.expandTimeout > 0 &&
                      !a.shown &&
                      (_.showTimer = setTimeout(function () {
                        I({
                ...
                expand: function (e) {
                  ...
                  (e = e || {}),
                    ...
                    e.noSaveState ||
                      ...
                      (o = 1),
                      window.localStorage &&
                        localStorage.setItem("vk_community_widget_" + t, o));
                },
                minimize: function () {
                  setTimeout(function () {
                    var e;
                    (f = 0),
                      ...
                      (e = "expanded"),
                      window.localStorage &&
                        localStorage.removeItem("vk_community_widget_" + e);
                  }, 120);
                },
                ...
                fatalError: function (t, o) {
                  var i = { code: t, widget: 2, public_id: o };
                  1903 == t && (i.referrer_domain = document.domain);
                  var n = [];
                  for (var s in i) n.push(s + "=" + i[s]);
                  e.destroy(r),
                    VK.Util.Box(
                      VK.Util.getAbsUrl("blank.php?" + n.join("&"))
                    ).show();
                },
                setPageTitle: function (e) {
                  a.disableTitleChange ||
                    (v(),
                    (o.oldTitle = document.title || null),
                    (o.title = e),
                    (o.changeTitleMode = 0),
                    y(1));
                },
            ...
            VK.Util.addEvent("popstate", C.bind(this, {}), window),
            VK.Util.addEvent("hashchange", C.bind(this, {}), window),
            {
              expand: I,
              minimize: function () {
                x("minimize");
    ...
    (VK.Widgets._constructor = function (e, t, o, i, n, r, s, a, d) {
      ...
      (r = r || {}),
        (n = n || {}),
        (o = o || {}).preview && ((i.preview = 1), delete o.preview);
      var p,
        u,
        c,
        h,
        ...
        m =
          "auto" === o.width
            ? 0 | (l.clientWidth || l.offsetWidth || r.minWidth)
            : parseInt(o.width || 0, 10);
      "silent_code" === i.act
        ? ((m = "1px"),
          (l.style.opacity = 0),
        ...
        : (m = m
            ? Math.max(r.minWidth || 200, Math.min(r.maxWidth || 1e4, m)) + "px"
            : "100%"),
        (l.style.width = m),
        o.height
          ? ((i.height = o.height), (l.style.height = o.height + "px"))
          : (l.style.height = (r.startHeight || 200) + "px"),
        "100%" === m && (i.startWidth = 0 | (l.clientWidth || l.offsetWidth)),
        i.url || (i.url = o.pageUrl || location.href.replace(/#.*$/, "")),
        (p = VK._domain.base + "/" + e),
        (u = ""),
        o.noDefaultParams ||
          (u +=
            "&app=" + (VK._apiId || "0") + "&width=" + encodeURIComponent(m)),
        (u += "&_ver=" + VK.version),
        VK._iframeAppWidget && (i.iframe_app = 1);
      var _ = VK.Util.getPageData();
      for (g in ((i.url = i.url || _.url || ""),
      (i.referrer = i.referrer || document.referrer || ""),
      (i.title = i.title || _.title || document.title || ""),
      i)) {
        if (
          ("title" == g &&
            i[g].length > 80 &&
      ...
      (p += "?" + (u += "&" + (+new Date()).toString(16)).substr(1)),
        n.onStartLoading && n.onStartLoading(),
        o.no_loading || VK.Widgets.loading(l, !0),
        ...
        (n.resizeWidget = function (e, t) {
          ...
          isFinite(e) &&
            ((l.style.width = e + "px"), i && (i.style.width = e + "px")),
            isFinite(t) &&
              ((l.style.height = t + "px"), i && (i.style.height = t + "px")),
            o.onResizeWidget && o.onResizeWidget();
        }),
        (n.updateVersion = function (e) {
          e > 1 &&
            VK.Api.attachScript(
              "//vk.com/js/api/openapi_update.js?" + parseInt(e)
            );
        }),
        (h = VK.Widgets.RPC[a] =
          new fastXDM.Server(
            ...
            function (e) {
              return (
                !e || (e = e.toLowerCase()).match(/(\.|\/)vk\.com($|\/|\?)/)
              );
            },
            { safe: !0 }
          ));
      ...
      o.custom_style &&
        "object" == typeof o.custom_style &&
        (y = VK.extend(y, o.custom_style));
      var v = "";
      return (
        o.enable_autoplay && (v = 'allow="autoplay"'),
        (f = VK.Widgets.RPC[a].append(
          l,
          {
            src: p,
        ...
        if (!VK._pData) {
          ...
          for (var n in t)
            if (
              t[n].getAttribute &&
              t[n].getAttribute &&
              ((e = t[n].getAttribute("name")) ||
                (e = t[n].getAttribute("property")))
            )
              for (var r in i)
                (e != i[r] && e != "og:" + i[r] && e != "vk:" + i[r]) ||
                  (o[i[r]] = t[n].content);
          o.app_id && !VK._apiId && (VK._apiId = o.app_id),
            ...
            !o.url &&
              ...
              VK._apiId &&
              ((o.url = "/app" + VK._apiId),
              VK._browserHash && (o.url += VK._browserHash));
        ...
        if (e && void 0 !== e) {
          ...
          if (void 0 !== e.getBoundingClientRect) {
            ...
            do {
              (o += e.offsetLeft),
                (i += e.offsetTop),
                t && ((o -= e.scrollLeft), (i -= e.scrollTop));
              ...
              o,
              {
                onInit: function () {
                  (a.style.background = "transparent"),
                    ...
                    r && (document.body.className += " layers_shown"),
                    VK.Util.Loader();
                },
                hide: function () {
    ...
    (VK.Retargeting = {
        ...
        if (this.pixelCode)
          if (IS_BRIDGE_AVAILABLE)
            ...
            (window.Image ? new Image() : document.createElement("img")).src =
              ...
              "/rtrg?p=" +
              this.pixelCode +
              (e ? "&event=" + encodeURIComponent(e) : "") +
              (o ? "&metatag_url=" + encodeURIComponent(o) : "") +
              (i ? "&metatag_title=" + encodeURIComponent(i) : "");
          }
      },
      Hit: function () {
        this.Event();
      ...
      ProductEvent: function (e, t, o, i) {
        if (this.pixelCode && t && e) {
          ...
          if ((p && (u.products_params = p), IS_BRIDGE_AVAILABLE))
            _bridgeSend("VKWebAppRetargetingPixel", {
              pixel_code: this.pixelCode,
              price_list_id: e,
              products_event: t,
      ...
      showErrors: function (e) {
        if (e || e.length) {
          ...
          if ("string" != typeof e) {
            var o = e.length;
            if (o) for (var i = 0; i < o; i++) console.error(t + e[i]);
      ...
      if (i && "string" == typeof i) {
        ...
        if ("string" == typeof n) {
          ...
          if (IS_BRIDGE_AVAILABLE)
            ...
            VK.Api.makeRequest(
              d,
              VK.Retargeting.onDone.bind(VK.Retargeting, !0)
            );
          }
